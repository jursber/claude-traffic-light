' ============================================================
' 统一守护进程守护脚本 (daemon_guard_unified.vbs)
' ============================================================
...
'
' 运行逻辑：
'   1. 用 pythonw.exe（无窗口）启动 daemon_unified.py
...
' pythonw.exe 的路径
strPythonW = "C:\Program Files\Python312\pythonw.exe"

' 如果 pythonw 不存在，尝试系统 PATH 中的
...
Do
    ...
    objShell.Run """" & strPythonW & """ daemon_unified.py", 0, True
